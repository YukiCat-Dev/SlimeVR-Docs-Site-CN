...
电池有很多不同选择, 通常按照你DIY的追踪器来决定. 每个Wemos D1 Mini需要一块电池。就电池续航而言, 每 100 mAh 能用一小时。因此，一块 1200 毫安时的电池通常可持续使用 12 小时左右
...
您需要一个充电控制器以确保电池安全充电。请记住在没有焊接二极管的情况下，如果充电时不小心让追踪器保持开启状态，则可能会损坏电池。 话虽如此，TP4056 充电板还提供了一些安全功能，例如过放电保护、过充电保护(仅当您没有 [二极管](#diodes-optional)时才会关闭!), 短路保护和过流保护。 
